...
2. Create git worktree in `{{work.directory}}`
...
```bash
git worktree add {{work.directory}}/<branch-name> -b <branch-name>
```
...
✓ Created git worktree
  - Branch: <branch-name>
  - Location: {{work.directory}}/<branch-name>
```
...
Next: cd {{work.directory}}/<branch-name>
```
